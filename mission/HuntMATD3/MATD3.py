...
class MATD3Agent:
    ...
    def save_model(self, model_dir, agent_id, agent_type):
        actor_path = os.path.join(model_dir, f"{agent_type}_{agent_id}_actor.pth")
        critic_path = os.path.join(model_dir, f"{agent_type}_{agent_id}_critic.pth")
